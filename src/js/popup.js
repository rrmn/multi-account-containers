...
Logic.registerPanel(P_CONTAINER_EDIT, {
  ...
  initializeRadioButtons() {
    ...
    const colors = ["blue", "turquoise", "green", "yellow", "orange", "red", "pink", "purple", "olive", "salmon", "skyblue", "tan", "violet", "orchid", "sienna", "slategray", "peru", "thistle", "cyan", "teal", "maroon", "navy", "lavender", "coral", "indigo", "peach", "mint", "gold", "silver", "brown"];
